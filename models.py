...
class PyUser(Base):
    ...
    def to_dict(self):
        # when i have obj which its type is obj of PyUser if we write obj.__dict__ we dont get a human-readable dict
        # so we write this method and we will call it like this :obj.to_dict this is a python method inside a python
        # class and do not relate to sqlalchemy and wont affect the table creation
        return {
            "id": self.id,
